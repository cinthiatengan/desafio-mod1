...
sagemaker_role='arn:aws:iam::944471524566:role/service-role/AmazonSageMaker-ExecutionRole-20210518T105032'
            ...
            'Outputs': [
                {
                    'OutputName': 'rais',
                    'S3Output': {
                        'S3Uri': 's3://cin-rais-prod-landing-zone-944471524566/rais',
